  ...
  const workingPapers = [
    {
      ...
      status:
        "AFA PhD Student Poster Session (2026); FMA (2025); China Banking and Corporate Finance Conference (CBCF) Young Scholars Forum (Spring) & Ba Li Tai Young Finance Scholars Forum (Jointly at Nankai University, 2025); UNC Charlotte Finance Seminar (2025)",
      link: "#",
    },
    {
