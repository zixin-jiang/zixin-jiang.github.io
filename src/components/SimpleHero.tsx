          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                ...
                <p>
                  My research interests are <span className="font-medium text-foreground whitespace-nowrap">empirical corporate finance</span>, <span className="font-medium text-foreground whitespace-nowrap">real estate finance</span>, <span className="font-medium text-foreground whitespace-nowrap">climate finance</span>, and <span className="font-medium text-foreground whitespace-nowrap">financial intermediation</span>.
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <p>
                  <span className="font-medium">B.A. in Economics (Financial Engineering)</span>, Wuhan University 2018
                </p>
              </div>
            </div>
